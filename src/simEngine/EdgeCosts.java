...
public class EdgeCosts {
    ...
    public int getAgentsOnEdge(int i, int j){
        return edges.get(createKey(i, j)).getAgents();
    }
    ...
    public Float[] getParameters(int i, int j) { return edges.get(createKey(i, j)).getCostFct().getParameters();}
